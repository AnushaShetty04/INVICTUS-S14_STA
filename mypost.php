  ...
  <div class="container">
	...
	<?php
        ...
        <div class="card-body col">
          ...
          <a href="#" class="btn align-self-end " >comment</a>
          </div>
          <div class="btn-group me-2" role="group" aria-label="Second group">
          <button class="btn me-1" >'.$row['upvotes'].'&nbsp<i class="fa fa-thumbs-up"></i></button>
          </div>
          <div class="btn-group" role="group" aria-label="Third group">
          <button class="btn"  >'.$row['downvotes'].'&nbsp<i class="fa fa-thumbs-down"></i></button>
          </div>
        </div>
        </div>
      </div> &nbsp &nbsp'."\r";
